...
var List = function () {
    ...
    var handleList = function () {
        ...
        jqGrid.jqGrid({
            caption: "短视频用户列表",
            url: hdnContextPath + "/management/userList",
            mtype: "post",
            styleUI: 'Bootstrap',//设置jqgrid的全局样式为bootstrap样式  
            datatype: "json",
            colNames: ['ID', '头像', '用户名', '昵称', '登录时间'],
            colModel: [
                ...
                {name: 'sessionKey', index: 'sessionKey', width: 30, sortable: false},
                {name: 'nickname', index: 'nickname', width: 30, sortable: false},
                {name: 'createTime', index: 'createTime', width: 20, sortable: false}
            ],
        ...
        $("#searchUserListButton").click(function () {
            ...
            jqGrid.jqGrid().setGridParam({
                page: 1,
                url: hdnContextPath + "/management/userList?" + searchUsersListForm.serialize()
            }).trigger("reloadGrid");
        });
    };
